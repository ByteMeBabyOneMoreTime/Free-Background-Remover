      ...
      <main className="container mx-auto px-4 py-12">
        ...
        >
          ...
          <p className="text-xl text-gray-600">
            Fast, easy, and high-quality background removal in seconds.
          </p>
        </motion.div>
        ...
        <div className="bg-white rounded-lg shadow-xl p-8 mb-12">
          <div className="mb-8">
            <label htmlFor="file-upload" className="cursor-pointer">
              <div className="flex items-center justify-center w-full h-32 border-2 border-indigo-300 border-dashed rounded-lg hover:bg-indigo-50 transition-colors">
          ...
          <button
            ...
            disabled={
              selectedFiles.length === 0 || currentProcessingIndex !== -1
            }
        ...
        <AnimatePresence>
          {processedImages.length > 0 && (
            ...
            >
              <h3 className="text-2xl font-semibold mb-6">Processed Images</h3>
                  ...
                  >
                    ...
                    <div className="absolute inset-0 bg-black bg-opacity-40 flex items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity rounded-lg">
                      <a
                        ...
                        download={`processed_image_${index + 1}.png`}
              ...
              <div className="mt-8 text-center">
                <button
                  ...
                  className="bg-green-500 hover:bg-green-600 text-white font-bold py-2 px-4 rounded-lg transition-colors inline-flex items-center"
                >
      ...
      <footer className="bg-gray-800 text-white py-12">
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div>
              <h4 className="text-xl font-semibold mb-4">About BG Remover</h4>
          ...
          <div className="mt-8 pt-8 border-t border-gray-700 text-center">
            <p className="text-gray-400">
              &copy; 2023 BG Remover. All rights reserved.
            </p>
          </div>
        </div>
      </footer>
